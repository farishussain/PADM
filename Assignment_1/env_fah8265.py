...
class PadmEnv(gym.Env):
    ...
    def __init__(self, grid_size=7):
        ...
        self.student_image = mpimg.imread('./student.png')
        self.blocker_images = {
            "Cancel": mpimg.imread('./Cancel.png')
        }
        self.task_image = mpimg.imread('./assignment.png')
        self.presentation_image = mpimg.imread('./presentation.png')
        self.finish_line_image = mpimg.imread('./exam.png')
